    ...
    sortedOrders.forEach(order => {
        ...
        billItem.innerHTML = `
            <div class="previous-bill-item-header">
                ...
                <div class="previous-bill-item-total">₹${order.total.toFixed(2)}</div>
            </div>
...
function showReportPreview(orders, itemSales, totalRevenue, startDate, endDate, totalSubtotal = 0, totalTax = 0) {
    ...
    previewDiv.innerHTML = `
        <div class="preview-summary">
            ...
            <p><strong>GST/Tax:</strong> ₹${totalTax.toFixed(2)}</p>
...
function generateDateRangeReport() {
    ...
    summaryDiv.innerHTML = `
        ...
        <p>GST/Tax: ₹${totalTax.toFixed(2)}</p>
...
function exportToExcel() {
    ...
    csvContent += `GST/Tax,₹${(currentReportData.totalTax || 0).toFixed(2)}\n`;
